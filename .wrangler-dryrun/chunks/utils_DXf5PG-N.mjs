...
import { q as mime } from "./index_BpQCdXij.mjs";
...
export {
  BASE_REQUIRED_FIELDS as B,
  FEATURED_IMAGE_FIELD as F,
  isInternalMetaKey as a,
  buildAttachmentMap as b,
  inferMetaType as c,
  mapMetaKeyToField as d,
  checkSchemaCompatibility as e,
  guessMimeType as f,
  getFilenameFromUrl as g,
  mapPostTypeToCollection as h,
  isInternalPostType as i,
  mapWpStatus as m,
  normalizeUrl as n,
  resolveImportByline as r
};
