...
export {
  handleOAuthClientGet as a,
  handleOAuthClientUpdate as b,
  handleOAuthClientList as c,
  handleOAuthClientCreate as d,
  handleOAuthClientDelete as h,
  lookupOAuthClient as l,
  validateClientRedirectUri as v
};
