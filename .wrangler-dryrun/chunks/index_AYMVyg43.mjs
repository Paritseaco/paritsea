...
${validation.errors.join("\n")}`);
  ...
  const { invalidateBylineCache } = await import("./index_BUgfGivc.mjs");
  const { invalidateRedirectCache } = await import("./cache_BMlQqQ4o.mjs");
  const { invalidateUrlPatternCache } = await import("./query_BT9SPCV1.mjs");
