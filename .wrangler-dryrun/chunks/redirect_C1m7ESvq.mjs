...
import { a as currentTimestampValue } from "./dialect-helpers_iTr-I2El.mjs";
...
export {
  RedirectRepository as R,
  isPattern as a,
  validateDestinationParams as b,
  compilePattern as c,
  interpolateDestination as i,
  matchPattern as m,
  validatePattern as v
};
