...
import { i as imageConfig } from "./_astro_assets_CIQy3b0Q.mjs";
import { P as isRemotePath } from "./index_BpQCdXij.mjs";
import { i as isRemoteAllowed } from "./worker-entry_ByB1knaX.mjs";
const qualityTable = {
  low: 25,
  mid: 50,
  high: 80,
