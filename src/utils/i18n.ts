...
export const ui = {
  en: {
    ...
    admin: "Admin",
    footerTagline: "An author-led intellectual practice and public record for work that is still moving and work that has become governed.",
    frameworkLayers: "Governed documents",
    thoughtPath: "Source record",
    ...
    authorRole: "Author and change authority for Paritsea",
    authorBio: "Parit Ritchai originates the observations and judgement published here. Paritsea preserves them as a public, versioned record that can be read independently of any commercial application.",
  ...
  th: {
    ...
    themeSystem: "ตามระบบ",
    admin: "จัดการเว็บ",
    footerTagline: "พื้นที่ปฏิบัติการทางความคิดที่มีผู้เขียนชัดเจน และเป็นบันทึกสาธารณะของทั้งงานที่ยังเคลื่อนไหวกับงานที่มีการกำกับแล้ว",
    frameworkLayers: "เอกสารที่มีการกำกับ",
    thoughtPath: "บันทึกต้นทาง",
    ...
    socialYouTube: "YouTube",
    authorName: "Parit Ritchai",
    authorRole: "ผู้เขียนและผู้มีอำนาจตัดสินใจต่อเนื้อหาต้นทางของ Paritsea",
    authorBio: "Parit Ritchai เป็นผู้สร้างข้อสังเกตและ judgment ที่เผยแพร่ที่นี่ ส่วน Paritsea รักษางานเหล่านั้นเป็นบันทึกสาธารณะที่มี version และอ่านได้โดยไม่ต้องผูกกับการนำไปใช้เชิงพาณิชย์",
