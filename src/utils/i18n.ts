...
export const ui = {
  ...
  th: {
    // Casual, easy‑to‑read Thai UI strings
    search: "ค้นหา…",
    menuOpen: "เปิดเมนู",
    menuClose: "ปิดเมนู",
    themeLight: "สว่าง",
    ...
    themeSystem: "ตามระบบ",
    admin: "แอดมิน",
    footerTagline: "กรอบอ้างอิงฟรี ใช้เข้าใจง่าย",
    // more natural phrasing
    frameworkLayers: "ชั้นของกรอบอ้างอิง",
    legalContact: "กฎหมาย & ติดต่อ",
    licensing: "ลิขสิทธิ์",
    contact: "ติดต่อ",
    languageSwitch: "EN",
    navLabels: {
      "The Doctrine": "หลักคำสอน",
      Protocols: "โปรโตคอล",
      Standards: "มาตรฐาน",
      "The Method": "วิธีการ",
    ...
    labels: {
      ...
      constitutionalDocument: "เอกสารพื้นฐาน",
      doctrineNotice: "เอกสารนี้เป็นฐานอำนาจของโปรโตคอลและมาตรฐานทั้งหมด",
      constitutionalDoctrine: "หลักคำสอนพื้นฐาน",
      protocol: "โปรโตคอล",
      standard: "มาตรฐาน",
