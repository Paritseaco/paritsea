...
export const ui = {
  en: {
    ...
    authorBio: "I read people and systems together. I turn confusion into structures that can be named, understood, and acted on. I combine multidimensional depth with clarity — reading situations, reading people, explaining complexity, and building frameworks that work across people, work, and business.",
  ...
  th: {
    ...
    authorName: "Parit Ritchai",
    authorRole: "Philosophy Architecture of Paritsea · Authority Director of SE Ocean",
    authorBio: "ฉันอ่านชีวิตคนและระบบไปพร้อมกัน แปลงความสับสนให้เป็นโครงสร้างที่นิยามได้ ตัดสินใจได้ และนำไปใช้ได้จริง ผสานมุมมองที่หลากมิติและลึก เพื่ออ่านสถานการณ์ อ่านคน และช่วยอธิบายความซับซ้อน และสร้าง framework ที่ใช้ได้กับคน งาน และธุรกิจ",
