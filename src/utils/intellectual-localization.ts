...
const thaiRecordMetadata: Record<string, IntellectualRecordMetadata> = {
	doctrine: {
		provenance: "เขียนโดย ปาริศ ฤทธิ์ชัย จากข้อสังเกตที่เกิดซ้ำเกี่ยวกับความสอดคล้องเชิงโครงสร้างและความชอบธรรม ฉบับ 1.1 เปลี่ยนจากข้อกล่าวอ้างว่าแก่นความคิดเปลี่ยนไม่ได้ มาเป็นการเปลี่ยนแปลงที่ต้องระบุผู้เขียน เหตุผล และเวอร์ชันอย่างเปิดเผย",
		...
		nonClaims: "Framework นี้ไม่ใช่หน่วยงานกำกับ ไม่ใช่ตรารับรองหรือผลการตรวจประเมิน และผู้ที่นำไปใช้ไม่มีสิทธิ์เปลี่ยนความหมายของต้นฉบับ",
	},
	stp: {
...
const thaiGenericMetadata: Record<string, IntellectualRecordMetadata> = {
	journal: {
		provenance: "ข้อสังเกตที่ฉันเขียนและเก็บไว้ใน Journal ก่อนพัฒนาเป็นงานอ้างอิง",
	...
	concept: {
		provenance: "แนวคิดที่พัฒนาจากข้อสังเกตและการตีความใน Journal",
...
export function localizeAppliedContext(
	...
	return {
		...
		summary: "ตัวอย่างการนำแนวคิดไปใช้กับปัญหาองค์กรที่ SE Ocean ดูแล การนำไปใช้ไม่เปลี่ยนความหมายหรือผู้รับผิดชอบงานต้นฉบับใน Paritsea",
	};
}
